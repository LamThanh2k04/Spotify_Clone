    ...
    <div className='flex justify-between items-center'>
      <div className='flex justify-center items-center'>
        ...
        <div className='flex flex-col '>
            <span className='text-5xl font-bold'>Music Manager</span>
            <span className='text-zinc-500'>Manager your music catalong </span>
        </div>
      </div>
      <div className='px-[10px] py-[10px] flex justify-center items-center bg-[#1E1E1E] rounded-full hover:text-white transition duration-200 hover:scale-[1.04] cursor-pointer'>
